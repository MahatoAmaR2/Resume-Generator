...
function Header() {
  return (
    <>
      <div className="w-full font-[font2] h-[56px] px-[32px] bg-primary text-white dark:border-b dark:border-b-[#535667] dark:bg-[#282828] flex justify-between items-center">
